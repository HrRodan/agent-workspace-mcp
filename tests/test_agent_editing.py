...
EXPECTED_FIB_400_DIV_2 = 176023680645013966468226945392411250770384383304492191886725992896575345044216019675 / 2
...
async def test_agent_file_editing():
    ...
    with trace("MCP-Editing-Workflow"):
        async with server:
            ...
            assert "82" in output_str or "10^82" in output_str or "10**82" in output_str or "e+82" in output_str
